...
let ar1 = [1, 2, 3, "hello world", 4.12, true];
...
let ar2 = [1, 2, 3, "hello world", 4.12, true];
...
function f8() {
  ...
  document.querySelector(".out-8").innerHTML = ar88;
...
function f16() {
  ...
  out16.innerHTML += ar16_odd + "<br>" + ar16_even;
}
