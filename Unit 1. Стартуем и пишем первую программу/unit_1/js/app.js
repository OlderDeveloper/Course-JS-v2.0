...
console.log("igor rodichev");

// task 2 --------------------
/* Выведите в консоль номер месяца в котором вы родились. 
Изучите чем отличается вывод числа и строки. */
...
// task 6 --------------------
/* Создайте на странице div с id=one. 
С помощью document.getElementById запишите в данный элемент текст 'Hello World'. */

document.getElementById('one').innerHTML = 'Hello World';

// task 7 --------------------
/* Создайте на странице div с id=two. С помощью document.getElementById запишите в данный элемент результат умножения 12 на 12. 
Умножение можно сделать с помощью знака звездочки ( цифра 8). */
...
document.querySelector('.three').innerHTML = '<h3>text</h3>';

// task 11 --------------------
/* Создайте пустой div c классом four. С помощью querySelector запишите внутрь div заголовок h4 с произвольным текстом и параграф p с 
произвольным текстом. Подсказка, чтобы дописывать внутрь элемента используейте не innerHTML = , а innerHTML += (плюс равно без пробела). */

document.querySelector('.four').innerHTML += '<h4>text</h4><p>text</p>'

// task 12 --------------------
/* Создайте параграф с классом five. Получите его в переменную a. С помощью innerHTML запишите внутрь переменной a число 3.1415. 
...
document.querySelector('.increase').innerHTML = z1 * z2;
...
document.querySelector('.concatenation').innerHTML = x1 + x2;
